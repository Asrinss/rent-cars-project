...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ ...props }: React.ComponentProps<typeof FaChevronLeft>) => (
          <FaChevronLeft className="h-4 w-4" {...props} />
        ),
        IconRight: ({ ...props }: React.ComponentProps<typeof FaChevronRight>) => (
          <FaChevronRight className="h-4 w-4" {...props} />
        ),
      }}
      {...props}
    />
